...
add wave -decimal uut/M2_unit/mult_op_1
add wave -decimal uut/M2_unit/mult_op_2
add wave -decimal uut/M2_unit/mult_op_3
add wave -decimal uut/M2_unit/mult_op_4
add wave -decimal uut/M2_unit/mult_res_1
add wave -decimal uut/M2_unit/mult_res_2
add wave -decimal uut/M2_unit/S_buff
add wave -decimal uut/M2_unit/S1_buff
add wave -decimal uut/M2_unit/T_buff
add wave -decimal uut/M2_unit/T1_buff
...
add wave -unsigned uut/M2_unit/read_addressa1
add wave -unsigned uut/M2_unit/read_addressb1
add wave -unsigned uut/M2_unit/read_addressa0
add wave -unsigned uut/M2_unit/read_addressb0
